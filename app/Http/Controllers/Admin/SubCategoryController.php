...
class SubCategoryController extends Controller
{
    ...
    public function UpdateSubCat(Request $request)
    {
        ...
        return redirect()->route('allsubcategory', 'Subcategory Category Updated Succesfully!');
    ...
    public function DeleteSubCat($id)
    {
        ...
        return redirect()->route('allsubcategory', 'Subcategory Category Deleted Succesfully!');
