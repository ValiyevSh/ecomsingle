...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page /</span> Edit Product Image
        </h4>
        <div class="row">
            <!-- Basic Layout -->
            <div class="col-xxl">
                    ...
                    <div class="card-body">
                        <form action="{{route('updateproductimg')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img style="width: 100px" src="{{asset($productinfo->product_img)}}">
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-primary">Updates  Product Image
                                    </button>
                                </div>
                            </div>
                        </form>
